"""Text-line grouping vendored from BallonsTranslator (GPL-3.0).

Source: ballontranslator/utils/textlines_merge.py, copied 2026-09-08.
Originally based on manga-image-translator. See LICENSE-BallonsTranslator.
The upstream grouping algorithm is preserved.
"""
